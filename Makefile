PROJECT_NAME := genesiscloud Package

SHELL            := /bin/bash
PACK             := genesiscloud
ORG              := genesiscloud
PROJECT          := github.com/${ORG}/pulumi-${PACK}
NODE_MODULE_NAME := @genesiscloud/pulumi-genesiscloud # @pulumi/${PACK}
TF_NAME          := ${PACK}
...
build_nodejs:: install_plugins tfgen # build the node sdk
	...
	cd sdk/nodejs/ && \
		...
		sed -i 's/"name": "@pulumi\/genesiscloud"/"name": "hello"/' ./bin/package.json # TODO: when provider is published under pulumi org

...
namespace GenesisCloud.PulumiPackage.Genesiscloud
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/genesiscloud";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("GenesisCloud.PulumiPackage.Genesiscloud.version.txt");
    ...
    internal sealed class GenesiscloudResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public GenesiscloudResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}

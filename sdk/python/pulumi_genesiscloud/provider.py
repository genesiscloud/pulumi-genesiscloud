...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] endpoint: Genesis Cloud API endpoint. May also be provided via `GENESISCLOUD_ENDPOINT` environment variable. If neither is
               provided, defaults to `https://api.genesiscloud.com/compute/v1`.
        :param pulumi.Input[str] polling_interval: The polling interval. - The string must be a positive [time duration](https://pkg.go.dev/time#ParseDuration), for
               example "10s".
...
class Provider(pulumi.ProviderResource):
    ...
    @property
    @pulumi.getter(name="pollingInterval")
    def polling_interval(self) -> pulumi.Output[Optional[str]]:
        """
        The polling interval. - The string must be a positive [time duration](https://pkg.go.dev/time#ParseDuration), for
        example "10s".
        """
